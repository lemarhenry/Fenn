                      ...
                      <div class="col-md-6">
                        ...
                        <div class="d-flex flex-column justify-content-center align-items-center h-100">
                          ...
                          <h4 class="subheading font-weight">
                            ...
                            <button type="button" class="btn btn-lily btn-margin btn-rounded text-white" >What we offer <i class="fas fa-caret-right ml-3"></i>
...
<br>
          ...
          <p  class="text-left dark-grey-text"> Long range WiFi systems are idea for sending signals up to 60 miles. This can be useful for sharing bandwidth,
